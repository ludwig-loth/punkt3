...
function setSubMenu() {
    ...
    if (hasSubMenu && projects.value && route.path.includes("/portfolio/")) {
            ...
            <div class="flex flex-col items-center justify-center px-0 max-w-7xl sm:pl-1 lg:pr-3">
                ...
                <div class="flex flex-row gap-5" ref="section_content">
                    <aside class="sticky z-40 hidden top-1 lg:top-5 sm:flex h-fit"
                        ...
                        <sidebarMainMenu :submenu="subMenuItemsPortfolio"
                            :hasSubMenu="hasSubMenu" />
                    </aside>
                    <section
                        class="relative flex flex-col p-2 rounded-sm mb-14 sm:mb-11 bg-base-200">
